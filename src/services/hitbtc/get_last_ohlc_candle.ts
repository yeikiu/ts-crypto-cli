...
export const getHitBTCLastOHLCCandle = async (symbols: string): Promise<stdOHLC> => {
    const candles = await hitbtcPublicApiRequest({ url: 'candles', params: { symbols, period: 'M1', sort: 'DESC', limit: 1 }})
